...
def build_extract_main_repo(data):
    with tempfile.TemporaryDirectory() as tempdirname:
        ...
        shutil.copy(os.path.join(tempdirname, 'vcmi-develop/clientapp/icons/vcmiclient.svg'), 'docs/assets/logo.svg')
        shutil.copy(os.path.join(tempdirname, 'vcmi-develop/clientapp/icons/vcmiclient.svg'), 'docs/assets/logo2.svg')
        shutil.copy(os.path.join(tempdirname, 'vcmi-develop/clientapp/icons/vcmiclient.16x16.png'), 'docs/assets/favicon.png')
